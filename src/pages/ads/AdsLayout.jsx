...
import { Menu, PlusCircle, Megaphone } from "lucide-react";
...
export default function AdsLayout() {
  ...
  const links = [
    { to: "/ads/create", label: "Create Ads", icon: PlusCircle },
    { to: "/ads/manage", label: "Manage Ads", icon: Megaphone },
  ];
        ...
        <div className="w-64 h-full bg-base-100 shadow-xl">
          ...
          <div className="p-4 border-b border-base-300">
            <div className="flex items-center justify-between">
              <div className="text-lg font-bold">Ads Dashboard</div>
              <button
